					...
					if (p) {
						...
						C({
							...
							var E = S === e && 0 === p,
								...
								_ = P({ element: u, actionItem: t, elementApi: m }, v)
							_t({
								store: n,
								element: u,
								actionItem: t,
			...
			(t.exports = function (t, e) {
				...
				function C(e) {
					if (!e.open) {
						...
						var i = r.env('editor')
						n || w.on(O, e.mouseUpOutside),
							e.hovering && !i && e.el.on(T, e.mouseLeave),
							e.hovering && i && w.on(I, e.mouseMoveOutside),
				...
				function L(t) {
					...
					if (t.open && (!t.config.hover || !t.hovering || r)) {
						...
						if (
							(E.outro(0, t.el[0]),
							w.off(O, t.mouseUpOutside),
							w.off(I, t.mouseMoveOutside),
...
Webflow.require('ix2').init({
	events: {
		e: {
			...
			target: {
				id: '6185b031ef3a00af70b3f572|c077044e-4e99-2029-31d6-42000bbff8dc',
				appliesTo: 'ELEMENT',
				styleBlockIds: [],
			},
			targets: [
		...
		'e-2': {
			...
			mediaQueries: ['main', 'medium', 'small', 'tiny'],
			target: {
				id: '6185b031ef3a00af70b3f572|c077044e-4e99-2029-31d6-42000bbff8b2',
				appliesTo: 'ELEMENT',
				styleBlockIds: [],
			},
			targets: [
		...
		'e-3': {
			...
			mediaQueries: ['main', 'medium', 'small', 'tiny'],
			target: {
				id: '6185b031ef3a00af70b3f572|c077044e-4e99-2029-31d6-42000bbff8cb',
				appliesTo: 'ELEMENT',
				styleBlockIds: [],
			},
			targets: [
		...
		'e-4': {
			...
			mediaQueries: ['main', 'medium', 'small', 'tiny'],
			target: {
				id: '6185b031ef3a00af70b3f572|c077044e-4e99-2029-31d6-42000bbff8e4',
				appliesTo: 'ELEMENT',
				styleBlockIds: [],
			},
			targets: [
		...
		'e-5': {
			...
			mediaQueries: ['main', 'medium', 'small', 'tiny'],
			target: {
				id: '6185b031ef3a00af70b3f572|c077044e-4e99-2029-31d6-42000bbff8d4',
				appliesTo: 'ELEMENT',
				styleBlockIds: [],
			},
			targets: [
		...
		'e-6': {
			...
			mediaQueries: ['main', 'medium', 'small', 'tiny'],
			target: {
				id: '6185b031ef3a00af70b3f572|c077044e-4e99-2029-31d6-42000bbff8c3',
				appliesTo: 'ELEMENT',
				styleBlockIds: [],
			},
			targets: [
		...
		'e-7': {
			...
			mediaQueries: ['main', 'medium', 'small', 'tiny'],
			target: {
				id: '6185b031ef3a00af70b3f572|c077044e-4e99-2029-31d6-42000bbff8aa',
				appliesTo: 'ELEMENT',
				styleBlockIds: [],
			},
			targets: [
		...
		'e-8': {
			...
			mediaQueries: ['main', 'medium', 'small', 'tiny'],
			target: {
				id: '6185b031ef3a00af70b3f572|c077044e-4e99-2029-31d6-42000bbff8ba',
				appliesTo: 'ELEMENT',
				styleBlockIds: [],
			},
			targets: [
		...
		'e-11': {
			...
			mediaQueries: ['main', 'medium', 'small', 'tiny'],
			target: {
				id: '6185b031ef3a00af70b3f572|c077044e-4e99-2029-31d6-42000bbff8f5',
				appliesTo: 'ELEMENT',
				styleBlockIds: [],
			},
			targets: [
		...
		'e-13': {
			...
			mediaQueries: ['main', 'medium', 'small', 'tiny'],
			target: {
				id: '6185b031ef3a00af70b3f572|c077044e-4e99-2029-31d6-42000bbff8ed',
				appliesTo: 'ELEMENT',
				styleBlockIds: [],
			},
			targets: [
		...
		'e-21': {
			...
			mediaQueries: ['main', 'medium', 'small', 'tiny'],
			target: {
				id: '6185b031ef3a00af70b3f572|0dc2c43e-65de-3b60-cc35-bb4d378d4535',
				appliesTo: 'ELEMENT',
				styleBlockIds: [],
			},
			targets: [
		...
		'e-23': {
			...
			mediaQueries: ['main', 'medium', 'small', 'tiny'],
			target: {
				id: '6185b031ef3a00af70b3f572|c50ac460-eb75-1e80-800c-10a056c21d10',
				appliesTo: 'ELEMENT',
				styleBlockIds: [],
			},
			targets: [
		...
		'e-25': {
			...
			mediaQueries: ['main', 'medium', 'small', 'tiny'],
			target: {
				id: '6185b031ef3a00af70b3f572|bb80fb2c-285b-c748-aa25-953bd2002d7b',
				appliesTo: 'ELEMENT',
				styleBlockIds: [],
			},
			targets: [
		...
		'e-27': {
			...
			mediaQueries: ['main', 'medium', 'small', 'tiny'],
			target: {
				id: '6185b031ef3a00af70b3f572|f55146a5-c001-cd2b-6f9d-4d8de2ce4567',
				appliesTo: 'ELEMENT',
				styleBlockIds: [],
			},
			targets: [
						...
						},
						{
							...
							config: {
								...
								target: {
									...
									selectorGuids: ['99780169-424c-ab9b-7f28-21c1b7ddade3'],
								},
								zValue: 0,
								xUnit: 'DEG',
								yUnit: 'DEG',
