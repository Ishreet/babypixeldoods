        ...
        `,
				...
				<span className='af-view'>
					<div className='af-class-body'>
						<header
							id='particles-js'
							className='af-class-particles-js-canvas-el'
						>
									...
									<div>
										<div className='af-class-div-block-9'>
											...
											<p className='af-class-paragraph-5'>
												...
												sales will be deposited into the Heartz DAO. When the
												Heartz DAO recieves funds, we will focus on buying the
												Doodles NFT project. Allowing our DAO to become one of
												the largest holders of an emerging blue-chip NFT will
												give our community a sense of identity and excitement.
												Snapshot.org will be used for DAO members to propose
												ideas that will be voted on by our DAO members.
												Fractional ownership voting will determine the direction
												of the Heartz DAO. Transparency will be provided
												throughout the entire project. We want to build a family
												here.
											</p>
										</div>
										<div className='af-class-div-block-9'>
