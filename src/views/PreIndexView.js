...
import PreContactFormView from './PreContactFormView'
import PreContactFormController from '../controllers/PreContactFormController'
...
class PreIndexView extends React.Component {
	...
	render() {
		const proxies =
			PreIndexView.Controller !== PreIndexView
